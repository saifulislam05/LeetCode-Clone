...
//   const { signIn, setUser, googleSignIn } = useUserAuth();
  ...
  return (
    <div
      className="w-screen md:h-full flex justify-center items-center"
      style={{ height: `calc(100vh - 3rem)` }}
    >
      <div className="w-10/12 h-full flex justify-center items-center">
        <div
          className="w-full sm:w-10/12 md:w-5/12 lg:w-4/12 mx-auto h-fit flex 
          flex-col"
        >
          ...
          <button
            className="btn rounded-xl w-fit mx-auto  items-center "
